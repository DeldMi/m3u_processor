...
// ChannelsPageV2 permanece apenas como referência/compatibilidade.
import {Channels} from "../features/channels/ChannelsPage";
import {ChannelAdminActions} from "../features/channels/ChannelAdminActions";
...
export function App(){
    ...
    if(path==="/channels")content=<><Channels user={user}/><ChannelAdminActions user={user}/></>;
