...
export type Status = { status: string; total_canais: number; canais_online: number; canais_offline: number; canais_desconhecidos?: number; ultimo_log: string; logs?: { timestamp: string; level: string; message: string }[]; log_count?: number; historico?: unknown[]; };
